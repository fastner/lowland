...
/*
 * Slightly modified version of NWEvents,
 * based upon great work of Diego Perini
 *
 *
 *
 *
...
(function(global) {
  ...
  var CUSTOM = 0, CAPTURING_PHASE = 1, AT_TARGET = 2, BUBBLING_PHASE = 3,
  ...
  W3C_MODEL = core.Env.getValue("eventmodel") == "W3C",
  MSIE_MODEL = core.Env.getValue("eventmodel") == "MSIE",
